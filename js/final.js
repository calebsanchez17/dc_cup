...
const dataEquipos = [
...

    {
        ...
        players: [
            { name: "777.", img: "jugador/701.png", elims: 0, kd: "0" },
            { name: "777.", img: "jugador/702.png", elims: 0, kd: "0" },
            { name: "777.", img: "jugador/703.png", elims: 0, kd: "0" },
            { name: "777.", img: "jugador/704.png", elims: 0, kd: "0" },
            { name: "777.", img: "jugador/.png", elims: 0, kd: "0" }
        ]
    },
...

    {
        ...
        players: [
            { name: "CR.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "CR.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "CR.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "CR.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "CR.", img: "jugador/.png", elims: 0, kd: "0" }
...

    {
        ...
        players: [
            { name: "04.papayadx7", img: "jugador/02.png", elims: 0, kd: "0" },
            { name: "04.Lewis44", img: "jugador/03.png", elims: 0, kd: "0" },
            { name: "04.LaraX", img: "jugador/004.png", elims: 0, kd: "0" },
            { name: "04.tilapia7v", img: "jugador/05.png", elims: 0, kd: "0" },
            { name: "04.bachira", img: "jugador/01.png", elims: 0, kd: "0" }
        ]
    },

    {
        ...
        players: [
            { name: "HLP.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "HLP.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "HLP.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "HLP.", img: "jugador/.png", elims: 0, kd: "0" },
            { name: "HLP.", img: "jugador/.png", elims: 0, kd: "0" }
...
function renderTabla() {
    ...
    // 1. Renderizar la tarjeta del Campeón (ligeramente más pequeña para ahorrar espacio)
    ...
    // 2. Renderizar LA TABLA (Una sola columna, un solo encabezado)

    let html = `<div class="s-col">`;

   

    // El encabezado gris se imprime UNA SOLA VEZ aquí
    ...
    // Recorremos todos los equipos de corrido
    ...
    html += `</div>`; // Cerramos la columna principal
...
function renderRosterView() {
    ...
    // Dividimos el nombre del equipo para el efecto de 2 bloques (Ej: "GRANADEROS" y "COLOMBIA")
    const nameParts = team.name.split(' ');
    const title1 = nameParts[0] || "EQUIPO";
    const title2 = nameParts.slice(1).join(' ') || team.name;

    // 1. Renderizar el Encabezado (Estilo bloques negro y blanco)
    ...
    // 2. Renderizar las 5 Cartas de Jugadores
    const playersContainer = document.getElementById('roster-players-container');
    
    playersContainer.innerHTML = team.players.map((p, i) => {
        // Fallbacks por si faltan datos o imágenes
        ...
        return `
        <div class="ff-card">
            <!-- Barra superior: Número y Nombre -->
...
function downloadImage(elementId, filename) {
    ...
    // Configuraciones recomendadas para evitar recortes o mala calidad

    html2canvas(element, {

        scale: 2, // Mayor calidad

        useCORS: true, // Permite cargar imágenes externas si el servidor lo permite

        backgroundColor: null // Mantiene el fondo definido por CSS
